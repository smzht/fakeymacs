...
keymap_real_emacs["(243)"]  = InputKeyCommand("C-Yen") # <半角／全角> キー
keymap_real_emacs["(244)"]  = InputKeyCommand("C-Yen") # <半角／全角> キー
keymap_real_emacs["A-(25)"] = InputKeyCommand("C-Yen") # Alt-` キー

keymap_real_emacs["(29)"]   = InputKeyCommand("C-F1")  # <無変換> キー
keymap_real_emacs["(28)"]   = InputKeyCommand("C-F2")  # <変換> キー
# keymap_real_emacs["O-LAlt"] = InputKeyCommand("C-F1")  # 左 Alt キーの単押し
# keymap_real_emacs["O-RAlt"] = InputKeyCommand("C-F2")  # 右 Alt キーの単押し
