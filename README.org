...
|---------------------+-------------------------------+--------------------------------------------------------|
| M-g p               | goto_previous_error           | Go to Previous Problem in Files (Error, Warning, Info) |
| M-g M-p             | goto_previous_error           | Go to Previous Problem in Files (Error, Warning, Info) |
| M-g n               | goto_next_error               | Go to Next Problem in Files (Error, Warning, Info)     |
| M-g M-n             | goto_next_error               | Go to Next Problem in Files (Error, Warning, Info)     |
| Ctl-x `             | goto_next_error               | Go to Next Problem in Files (Error, Warning, Info)     |
