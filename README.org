...
1. [[fakeymacs_manuals/manual-configuration_parameters.org][Configuration parameters]]
1. [[fakeymacs_manuals/manual-key_bindings.org][Key bindings]]
1. [[fakeymacs_manuals/manual-extensions.org][Extensions]]
1. [[fakeymacs_manuals/manual-functions.org][Functions]]
...
| fakeymacs_extensions/* | 機能拡張用ファイルです。デフォルトは無効となっていますが、config_personal.py の中で有効にすることができます。 |
|------------------------+---------------------------------------------------------------------------------------------------------------|
