...
| [[/fakeymacs_extensions/zed_key][zed_key]]                 | Zed エディタ用のキーの設定を行う                                                              | お勧め！   |
...
| [[/fakeymacs_extensions/fresh_key][fresh_key]]               | Fresh Editor 用のキーの設定を行う                                                             | お勧め！   |
| [[/fakeymacs_extensions/vim_key][vim_key]]                 | Vim 系エディタ用のキーの設定を行う                                                            | お勧め！   |
| [[/fakeymacs_extensions/elecxzy_key][elecxzy_key]]             | elecxzy エディタ用のキーの設定を行う                                                          | お勧め！   |
| [[/fakeymacs_extensions/mc_key][mc_key]]                  | Midnight Commander 用のキーの設定を行う                                                       | お勧め！   |
