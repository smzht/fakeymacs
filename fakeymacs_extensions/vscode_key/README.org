...
| C-A-b   | mark + backward_char          | cursorLeftSelect                           |             |
| C-A-f   | mark + forward_char           | cursorRightSelect                          |             |
| C-A-a   | mark + move_beginning_of_line | cursorHomeSelect                           |             |
| C-A-e   | mark + move_end_of_line       | cursorEndSelect                            |             |
