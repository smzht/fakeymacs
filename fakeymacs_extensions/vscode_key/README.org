...
| C-<数字キー>   | switch_focus(<数字キーの値>) | View: Focus Side Bar or n-th Editor Group | fc.use_ctrl_digit_key_for_digit_argument が False の場合 |
| C-A-<数字キー> | switch_focus(<数字キーの値>) | View: Focus Side Bar or n-th Editor Group | fc.use_ctrl_digit_key_for_digit_argument が True の場合  |
|----------------+------------------------------+-------------------------------------------+----------------------------------------------------------|
...
| C-<n>         | switch_focus(<n>) | Focus Side Bar or n-th Editor Group |                     |
| C-A-<n>       | switch_focus(<n>) | Focus Side Bar or n-th Editor Group |                     |
|---------------+-------------------+-------------------------------------+---------------------|
