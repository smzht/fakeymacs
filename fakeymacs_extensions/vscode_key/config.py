...
define_key(keymap_vscode, "C-A-b",   reset_search(reset_undo(reset_counter(mark2(repeat(backward_char), None)))))
define_key(keymap_vscode, "C-A-f",   reset_search(reset_undo(reset_counter(mark2(repeat(forward_char), None)))))
define_key(keymap_vscode, "C-A-a",   reset_search(reset_undo(reset_counter(mark2(move_beginning_of_line, None)))))
define_key(keymap_vscode, "C-A-e",   reset_search(reset_undo(reset_counter(mark2(move_end_of_line, None)))))
