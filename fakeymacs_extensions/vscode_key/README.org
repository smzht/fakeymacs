...
| C-A-S-s | skip_to_previous_like_this | Move Last Selection To Previous Find Match   |             |
| C-A-e   | expand_region              | Expand Selection                             |             |
| C-A-S-e | shrink_region              | Shrink Selection                             |             |
