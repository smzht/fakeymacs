...
| CTrl+Alt+Shift+d    | mark_all_like_this            | Select All Occurrences of Find Match                   |
| Ctrl+Alt+r          | skip_to_previous_like_this    | Move Last Selection To Previous Find Match             |
