...
| C-<n>   | switch_focus(<n>)    | Go to tab #n           | fc.use_ctrl_digit_key_for_digit_argument が False の場合、n は 0 ～ 9 の値 |
| C-A-<n> | switch_focus(<n>)    | Go to tab #n           | fc.use_ctrl_digit_key_for_digit_argument が True の場合、n は 0 ～ 9 の値  |
|---------+----------------------+------------------------+----------------------------------------------------------------------------|
