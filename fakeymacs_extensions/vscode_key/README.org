...
|--------------------------------------+--------------------------------------+-------------|
| fc.vscode_replace_key[n][0] の設定値 | fc.vscode_replace_key[n][1] の設定値 |             |
|--------------------------------------+--------------------------------------+-------------|
...
|--------------------------------------+--------------------------------------+-------------|
| fc.cursor_replace_key[n][0] の設定値 | fc.cursor_replace_key[n][1] の設定値 |             |
|--------------------------------------+--------------------------------------+-------------|
...
このため、本設定は、利用頻度の高いキーの置き換えに利用するのが良いのではないかと思います。
（初期値では、C-k を C-A-k に、C-l を C-A-l に置き換える設定を入れています。
設定は、自由に変更することが可能です。）
