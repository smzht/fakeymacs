...
if not is_japanese_keyboard:
    ...
    try:
        ...
        define_key(fc.keymap_vscode, "S-Back", keymap.defineMultiStrokeKeymap("S-Back"))

        define_key(fc.keymap_vscode, "S-Back C-S-Back", getKeyCommand(fc.keymap_vscode, "C-S-BackQuote"))
        define_key(fc.keymap_vscode, "S-Back C-Back",   getKeyCommand(fc.keymap_vscode, "C-BackQuote"))
